  ...
  return (
    <div data-slot="command-input-wrapper" className="cn-command-input-wrapper">
      <InputGroup className="cn-command-input-group">
        ...
        />
        <InputGroupAddon>
          <MagnifyingGlass className="cn-command-input-icon" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  )
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <Check weight="bold" className="cn-command-item-indicator ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  )
}
